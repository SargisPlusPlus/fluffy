FROM ubuntu:trusty
MAINTAINER Sargis Dudaklyan <sargisdudaklyan@gmail.com>
...
RUN rm -rf /home/fluffy/src

ADD docker-entrypoint.sh /home/fluffy/docker-entrypoint.sh
ADD setup.sh /home/fluffy/setup.sh
# ADD nginx.conf /home/fluffy/nginx.conf

ENV RAILS_ENV=production

EXPOSE 80:80

ENTRYPOINT /home/fluffy/docker-entrypoint.sh
